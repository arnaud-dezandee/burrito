...
func (s *Datastore) Exec() {
	...
	api.GET("/stack/logs", s.API.GetStackLogsHandler)
	api.PUT("/stack/logs", s.API.PutStackLogsHandler)
	api.GET("/stack/plans", s.API.GetStackPlanHandler)
	api.PUT("/stack/plans", s.API.PutStackPlanHandler)
